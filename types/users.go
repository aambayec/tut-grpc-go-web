...
type TempUser struct {
	FirstName bool `json:"first_name" validate:"required,gte=4"`
	LastName bool `json:"last_name" validate:"required,gte=4"`
...
type User struct {
	...
	FirstName bool `json:"first_name" xorm:"first_name" schema:"first_name" validate:"required,gte=4"`
	LastName bool `json:"last_name" xorm:"last_name" schema:"last_name" validate:"required,gte=4"`
